...
Extraction evidence: WF-EXT-02 — legacy characterization fixtures completed.
...
increment. Empty layer directories are intentionally absent. WF-EXT-02 fixtures
live under `tests/workforce/` and add no source-layer dependency. WF-EXT-03 may add
the first approved public Application facade and focused ports after its own
evidence passes.
