...
WF-PRE-07 through WF-PRE-14 subsequently approved every ordered design/planning decision through the [migration/rollback runbook](workforce-migration-runbook.md). [WF-PRE-16](workforce-module-readiness-decision.md) passed ordered extraction entry, and [WF-EXT-01](workforce-extraction-entry.md) registered structure only. WF-EXT-02 characterization fixtures are next.
